...
parser.add_argument("--cpu_type", type=str, default="TimingSimpleCPU", choices=["TimingSimpleCPU", "MinorCPU", "MyMinorCPU", "O3CPU"], help="CPU type.")
parser.add_argument("--fpu_operation_latency", type=int, default=6,  help="CPU fpu_operation_latency. Default:6")
parser.add_argument("--fpu_issue_latency", type=int, default=1,  help="CPU fpu_issue_latency. Default:1")
parser.add_argument("--int_operation_latency", type=int, default=3,  help="CPU int_operation_latency. Default:3")
...
#parser.add_argument("--N", type=str, default="65536", choices=["DDR3_1600_8x8", "DDR3_2133_8x8", "LPDDR2_S4_1066_1x32", "HBM_1000_4H_1x64", "HBM_2000_4H_1x64"], help="Memory type.")
...
if options.cpu_type == "TimingSimpleCPU":
    ...
    system.cpu = X86O3CPU()
elif options.cpu_type == "MyMinorCPU":
...
# process
process = Process()
process.cmd = [options.binary,"65536"]
